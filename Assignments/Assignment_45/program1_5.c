...
//  Description:    It use to count frequency of elements smaller than 
//                  given number. 
//  Input:          pointer,int
//  Output:         int
//  Author:         Atharva Sanjay Dhumal.
...
int main()
{
    ...
    iRet = CountLess(First,iValue);

    printf("Number of Samller elements is:%d",iRet);
...
//Enter the number:
//21
//Number of Samller elements is:2
////////////////////////////////////////////////////////////////////////////////////
